...
@Slf4j
public class ScoreBetween500And1000IncomeLessThen5000Handler extends CreditApplicationHandler {
    @Override
    public CreditDTO handle(Integer creditScore, CreditApplicationRequest creditApplicationRequest) {
        if(creditScore>=500 && creditScore<1000
            ...
            log.info("CreditApplicationRequest {} handled by {} with result {}", creditApplicationRequest, this.getClass(), creditDTO);
            return creditDTO;
        }
